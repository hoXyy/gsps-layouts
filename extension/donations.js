...
function updateToReadDonations() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const donationsToAcceptResp = yield (0, needle_1.default)('get', `${rootURL}/search?event=${eventID}&type=donation&commentstate=PENDING&transactionstate=COMPLETED`, { cookies: cookies });
