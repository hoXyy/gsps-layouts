...
const socketConfig = (0, nodecg_1.get)().bundleConfig.donationSocket;
...
if (socketConfig.enabled) {
    const socket = (0, socket_io_client_1.default)(socketConfig.url);
    ...
    totalLog.warn(`cfg/${(0, nodecg_1.get)().bundleName}.json has the donation socket disabled.` +
